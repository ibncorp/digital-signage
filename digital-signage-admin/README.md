...
```bash
git clone git@github.com:startbootstrap/digital-signage-admin.git
cd digital-signage-admin
npm install
npm start
```
...
Digital Signage Admin come with a production ready Dockerfile and build scripts.
